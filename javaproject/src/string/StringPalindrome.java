...
public class StringPalindrome {
	...
	public static void main(String[] args) 
	{
		...
		//String s = word1.reverse().toString();
		//String s2 = word2.reverse().toString();
		//String rev1 = word1.reverse();
		//String rev2 = word2.reverse();
		...
		//if(word1.equals(s))
		//if(dupWord1.toStringequals(word1.toString().reverse()))
